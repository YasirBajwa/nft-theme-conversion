          ...
          <div className="hero_privacy">
            <div className="container">
              <div className="d-flex jusitify-content-center align-items-center space-x-10">
                <h1 className="text-left">Raroin Privacy</h1>
              ...
              <div className="box space-y-30" style={{ padding: "60px 30px" }}>
                <div className="space-y-20">
                  ...
                  <p>
                    ...
                    site and gather data when you participate in the forum by
                    ...
                    an email containing a unique link. If that link is visited,
                ...
                <div className="space-y-20">
                  ...
                  <p>
                    ...
                    one of the following ways: To personalize your experience —
                    your information helps us to better respond to your
                    individual needs.
                    <br />
                    To improve our site — we continually strive to improve our
                    site offerings based on the information and feedback we
                    receive from you. To improve customer service — your
                    information helps us to more effectively respond to your
                    customer service requests and support needs. To send
                    periodic emails — The email address you provide may be used
                    to send you information, notifications that you request
                    about changes to topics or in response to your user name,
                ...
                <div className="space-y-20">
                  ...
                  <p>
                    ...
                    your Web browser (if you allow). These cookies enable the
                    site to recognize your browser and, if you have a registered
                    ...
                    understanding our site visitors. These service providers are
                    not permitted to use the information collected on our behalf
                ...
                <div className="space-y-20">
                  ...
                  <p>
                    ...
                    our site, conducting our business, or servicing you, so long
